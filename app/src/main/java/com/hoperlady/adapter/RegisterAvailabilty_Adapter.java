...
public class RegisterAvailabilty_Adapter extends BaseAdapter {
    LayoutInflater inflater;
    ArrayList<AvailDayPojo> myMainArr;
    ArrayList<Availability_selecting_pojo> selectingArray = null;
    private Context context;

    public RegisterAvailabilty_Adapter(Context context, ArrayList<AvailDayPojo> aMainArr) {
...
//            view = inflater.inflate(R.layout.availability_child_layout, parent, false);
            view = inflater.inflate(R.layout.availability_inflate_layout, parent, false);
