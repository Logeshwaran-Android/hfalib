...
import com.hoperlady.app.StatisticsPage;
...
//
//            } else {
//                if (tasker_availability_status.equalsIgnoreCase("1")) {
//                    myStatusTGB.setChecked(true);
...
//            }
        ...
        myStatusTGB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (myStatusTGB.isChecked() == true) {
                    myAvailabilityTXT.setText(getResources().getString(R.string.availabe_title));
    ...
    public void onComplete(RippleView aRippleView) {
        switch (aRippleView.getId()) {
            ...
            case R.id.screen_home_page_RPL_jobs:
                Intent aJobsIntent = new Intent(getActivity(), com.hoperlady.app.MyJobs.class);
...
//                        myStatusTGB.setCheckedImmediately(false);
//                        myAvailabilityTXT.setText(getResources().getString(R.string.unavailabe_title));
                        Alert(getResources().getString(R.string.admin_notification), getResources().getString(R.string.navigation_menu_adapter_verify_your_account));
                    }
