...
import com.hoperlady.adapter.JobWorkFlow_Adapter;
...
public class Job_WorkFlow extends ActionBarActivityHockeyApp {
    ...
    private void initilize() {
        ...
        if (isInternetPresent) {
            ...
            WorkFlowRequest(Job_WorkFlow.this, ServiceConstant.JOB_WORKFLOW_URL);
    ...
    private void WorkFlowRequest(Context mContext, String url) {
        ...
        System.out.println("WorkFlowRequest jsonParams" + jsonParams);
        ...
        mservicerequest.makeServiceRequest(url, Request.Method.POST, jsonParams, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                System.out.println("WorkFlowRequest response" + response);
