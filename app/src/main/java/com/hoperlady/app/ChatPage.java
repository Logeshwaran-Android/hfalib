...
import com.hoperlady.Pojo.ChatPojo;
...
import com.hoperlady.Utils.TouchImageView;
import com.hoperlady.adapter.ChatAdapter;
...
public class ChatPage extends ActivityHockeyApp implements View.OnClickListener {
    ...
    public static AppCompatActivity myChatPages;
    private Receiver receive;
    public static String chat_msg_id = "";
    public static AppCompatActivity chat_activity;
    ...
    RelativeLayout chatPage_bottom_main_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, Uri.parse("android.resource://com.maidacpartner/" + R.raw.notifysnd));
        try {
...
//                Et_message.getText().clear();
    ...
    private void initialize() {
        ...
        chatPage_bottom_main_layout = (RelativeLayout) findViewById(R.id.chatPage_bottom_main_layout);
        chatPage_bottom_main_layout.setVisibility(View.VISIBLE);
        ...
        if (intent != null) {
            ...
            if (getIntent().hasExtra("btn_group")) {
                sBtn_group = getIntent().getStringExtra("btn_group");
            }

            if (sBtn_group.equalsIgnoreCase("7")) {
                chatPage_bottom_main_layout.setVisibility(View.GONE);
            } else {
                chatPage_bottom_main_layout.setVisibility(View.VISIBLE);
            }
    ...
    protected void onResume() {
        ...
        try {
            smanager = new SocketManager(ChatPage.this, new SocketManager.SocketCallBack() {
                @Override
                public void onSuccessListener(Object response) {
                    Log.e("smanager", "smanager" + smanager.isConnected);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
