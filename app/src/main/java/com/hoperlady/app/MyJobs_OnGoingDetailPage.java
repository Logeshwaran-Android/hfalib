...
import com.hoperlady.Utils.onItemRemoveClickListener;
 ...
 */
public class MyJobs_OnGoingDetailPage extends AppCompatActivity implements OnMapReadyCallback, com.google.android.gms.location.LocationListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detail_btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (detail_btn2.getText().equals("Accept")) {
                ...
                } else if (detail_btn2.getText().equals("Start Off")) {
                    if (isInternetPresent) {
                ...
                } else if (detail_btn2.getText().equals("Arrived")) {
                    if (isInternetPresent) {
                ...
                } else if (detail_btn2.getText().equals("Start job")) {
        ...
        detail_btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (detail_btn1.getText().equals("Reject")) {
                    // onBackPressed();
                ...
                } else if (detail_btn1.getText().equals("Complete Job")) {
                    detail_btn2.setVisibility(View.GONE);

                    Materail_Add_ALert();

                } else if (detail_btn1.getText().equals("Payment")) {
                    detail_btn2.setVisibility(View.GONE);
                ...
                } else if (detail_btn1.getText().equals("Cancel")) {
                ...
                } else if (detail_btn1.getText().equals("Cancel Reason")) {
                    detail_btn2.setVisibility(View.GONE);
                    Intent intent = new Intent(MyJobs_OnGoingDetailPage.this, Cancel_Job_Reason.class);
                    intent.putExtra("JobId", str_jobId);
                    startActivity(intent);
                    overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
                } else if (detail_btn1.getText().equals("More Info")) {
                    detail_btn2.setVisibility(View.GONE);
                    Intent intent = new Intent(MyJobs_OnGoingDetailPage.this, PaymentFareSummery.class);
                    intent.putExtra("JobId", str_jobId);
                    startActivity(intent);
        ...
        Tv_ongoing_detail_jobinstruction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mservicerequest.makeServiceRequest(url, Request.Method.POST, jsonParams, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                if (Str_status.equalsIgnoreCase("1")) {
                    ...
                    Toast.makeText(MyJobs_OnGoingDetailPage.this, Str_message, Toast.LENGTH_SHORT).show();
            ...
            public void onCompleteListener(String response) {
                ...
                try {
                    ...
                    if (Str_status.equalsIgnoreCase("1")) {
                        ...
                        User_image = Str_userimg;
                        User_name = Str_jobusername;
                        ...
                        if (object2.has("exactaddress") && !object2.getString("exactaddress").equalsIgnoreCase("")) {
                            String addreses = object2.getString("exactaddress");
                            Tv_ongoing_location.setText(addreses);
                            address = addreses;
                        } else {
                    ...
                    if (Str_status.equalsIgnoreCase("1")) {
                        ...
                        if (Str_job_group.equalsIgnoreCase("1")) {
                            ...
                            detail_btn2.setVisibility(View.GONE);
                            detail_btn1.setVisibility(View.VISIBLE);
                            detail_btn1.setText(getResources().getString(R.string.myjobs_ongoing_details_job_completed));
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    case LocationSettingsStatusCodes.SUCCESS:
                        Intent intent = new Intent(MyJobs_OnGoingDetailPage.this, TrackYourRide.class);
            ...
            public void onCompleteListener(String response) {
                ...
                if (Str_status.equalsIgnoreCase("1")) {
                    ...
                    if (Str_btn_group.equalsIgnoreCase("6")) {
                        detail_btn2.setVisibility(View.GONE);
                        detail_btn1.setVisibility(View.VISIBLE);
                        detail_btn1.setText(context.getResources().getString(R.string.ongoing_detail_more_label));
