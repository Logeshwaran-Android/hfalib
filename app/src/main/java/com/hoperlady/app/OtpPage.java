...
public class OtpPage extends SubClassActivity {
    ...
    public static AppCompatActivity OTp_PageActivity;
    EditText Et_otp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BT_otp_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (!Str_otp_code.equals(Et_otp.getText().toString())) {
                    Alert(getResources().getString(R.string.lbel_notification), getResources().getString(R.string.otp_label_alert_invalid));
                } else {
    ...
    private void otpPost(Context mContext, String url) {
        ...
        mservicerequest.makeServiceRequest(url, Request.Method.POST, jsonParams, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                String Str_status = "", Str_response = "", Str_currency = "", Str_otp_status = "", Str_jobId = "", Str_message = "";
                try {
