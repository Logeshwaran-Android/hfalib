                    ...
                    if (Str_status.equalsIgnoreCase("1")) {
                        ...
                        if (jarry.length() > 0) {
                            ...
                            for (int i = 0; i < jarry.length(); i++) {
                                ...
                                pfPojo.setPayment_title(jobjects_amount.getString("title"));
                                String amount = jobjects_amount.getString("amount");

                                if (dt.equals("0")) {
                                    pfPojo.setPayment_amount(jobjects_amount.getString("amount"));
                                } else {
                                    pfPojo.setPayment_amount(currencyCode + jobjects_amount.getString("amount"));
                                }
