...
import com.hoperlady.adapter.PaymentFareSummeryAdapter;
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("com.package.refresh.paymentfaresummery")) {
                ...
                if (isInternetPresent) {
                    PaymentRequest(PaymentFareSummery.this, ServiceConstant.PAYMENT_URL);
                    System.out.println("requestpayment------------------" + ServiceConstant.PAYMENT_URL);
                } else {
...
//                overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
    ...
    private void PaymentRequest(Context mContext, String url) {
        ...
        mservicerequest.makeServiceRequest(url, Request.Method.POST, jsonParams, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                String Str_status = "", Str_response = "", Str_jobDescription = "", Str_NeedPayment = "", Str_Currency = "", Str_BtnGroup = "", aCashOptionStr = "";
                    ...
                    if (Str_status.equalsIgnoreCase("1")) {
                        ...
                        if (jarry.length() > 0) {
                            ...
                            for (int i = 0; i < jarry.length(); i++) {
                                ...
                                String dt = jobjects_amount.getString("dt");
                                if (dt.equals("0")) {
...
//                    Alert(getResources().getString(R.string.server_lable_header), Str_response);
                    ...
                    Toast.makeText(PaymentFareSummery.this, Str_response, Toast.LENGTH_SHORT).show();
