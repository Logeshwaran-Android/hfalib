            ...
            public void onCompleteListener(String response) {
                ...
                if (Str_Status.equalsIgnoreCase("1")) {
                    ...
                    mdialog.setPositiveButton(getResources().getString(R.string.server_ok_lable_header), new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    mdialog.dismiss();
                                    OtpPage.OTp_PageActivity.finish();
                                    ...
                                    Intent refreshBroadcastfaree = new Intent();
                                    refreshBroadcastfare.setAction("com.finish.PaymentFareSummeryPage");
                                    sendBroadcast(refreshBroadcastfaree);

//                                    Intent intent = new Intent(ReceiveCashPage.this, ReviwesPage.class);
                                    Intent intent = new Intent(ReceiveCashPage.this, RatingSmilyPage.class);
