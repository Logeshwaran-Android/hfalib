    ...
    private void LatLongRequest(String Url) {
        ...
        mRequest.makeServiceRequest(Url, Request.Method.GET, null, new ServiceRequest.ServiceListener() {
            ...
            public void onCompleteListener(String response) {
                ...
                System.out.println("--------------LatLong  reponse-------------------" + response);
                String status = "", sArea = "", sLocality = "", sCity_Admin1 = "", sCountry_Admin1 = "",sCity_Admin2 = "", sPostalCode = "";
                try {
                    JSONObject object = new JSONObject(response);
                    if (object.length() > 0) {
                                    ...
                                    for (int i = 0; i < addressArray.length(); i++) {
                                        ...
                                        if (typesArray.length() > 0) {
                                            for (int j = 0; j < typesArray.length(); j++) {
                                                ...
                                                {
                                                    sCountry_Admin1 = address_object.getString("long_name");
                                                }
                ...
                if (isdataAvailable) {
                    ...
                    returnIntent.putExtra("country",sCountry_Admin1);
