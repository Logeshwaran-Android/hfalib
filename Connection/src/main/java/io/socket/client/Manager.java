...
/*     */ public class Manager extends Emitter {
    ...
    public Manager(URI uri, Options opts) {
        ...
        this.reconnectionDelay(opts.reconnectionDelay != 0 ? opts.reconnectionDelay : 1);
        this.reconnectionDelayMax(opts.reconnectionDelayMax != 0 ? opts.reconnectionDelayMax : 1);
    ...
    private void updateSocketIds() {
        for (Entry<String, Socket> entry : this.nsps.entrySet()) {
    ...
    Log.e("SOCKET","RECONNECT");
        ...
        if (this.backoff.getAttempts() >= this._reconnectionAttempts) {
          ...
          //  Log.e("SOCKET", "DELAY" + " " + String.valueOf(delay));
